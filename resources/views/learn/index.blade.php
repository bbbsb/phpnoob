            ...
            <div class="sidebar-box gallery-list">
                <div class="design" id="leftcolumn">
                    ...
                    @foreach($articles as $article)
                        <a target="_top" title="{{$article->title}}" href="{{url('show/'.$article->id)}}">
                            {{$article->title}}
                        </a>
                    @endforeach
                    <a target="_top" title="PHP 简介" href="/php/php-intro.html">
                        PHP 简介
                    </a>
                    <a target="_top" title="PHP 安装" href="/php/php-install.html">
                        PHP 安装
                    </a>
                    <a target="_top" title="PHP 语法" href="/php/php-syntax.html">
                        PHP 语法
                    </a>
